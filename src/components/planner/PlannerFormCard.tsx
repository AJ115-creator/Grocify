...
const categories: GroceryCategory[] = ["Produce", "Dairy", "Bakery", "Pantry", "Snacks"]; //Category of Groceries
const priorities: GroceryPriority[] = ["low", "medium", "high"]; //Priorites for Grocery
